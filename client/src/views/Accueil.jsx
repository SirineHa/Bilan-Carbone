...
export const Accueil = () => {
  return (
    <div className="bg-[#ebf3f5] flex flex-row justify-center w-full">
      <div className="bg-variable-collection-background overflow-hidden w-[1440px] h-[1024px]">
        <div className="relative w-[2797px] h-[1800px] top-[-480px] left-[57px]">
          <div className="absolute w-[2797px] h-[1800px] top-0 left-0">
            <div className="absolute w-[2100px] h-[1800px] top-0 left-[697px]">
